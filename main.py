...
class Runner(dbus.service.Object):
    def __init__(self):
        dbus.service.Object.__init__(self, dbus.service.BusName("org.kde.its_mypic", dbus.SessionBus()), objpath)
    ...
    def Match(self, query: str):
        ...
        if query == "hello":
            ...
            return [("Hello", "Hello from its_mypic!", "document-edit", 100, 1.0, {'subtext': 'Demo Subtext'})]
        return []
